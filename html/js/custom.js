...
$(document).ready(function() {
	$(document).on("click", ".startvpn", function() {
		$.ajax({
		   url: "../includes/startvpn.php",
		   success: function(data){
			   console.log("return startVpn", data);
	...
	$(document).on("click", ".stopvpn", function() {
		$.ajax({
		   url: "../includes/stopvpn.php",
		   success: function(data){
			   console.log("return stopVpn", data);
			setTimeout(function(){
           window.location.reload(true);
        }, 2000);
		   }
	...
	$(document).on("click", ".stopberry", function() {
		$.ajax({
		   url: "../includes/stopberry.php",
		   success: function(data){
			   console.log("return stop", data);
